...
function Header() {
  return (
    <nav className='flex w-full bg-pink-900 text-white font-bold fixed justify-between p-5 text-2xl'>
        ...
        <ul className='flex '>
            <li className='px-5 text-lg'><Link to={'/wishlist'}><i className="fa-solid fa-heart fa-sm me-1 text-red-600" ></i>Wishlist <span className='p-1 bg-black mx-1 rounded-full text-center'>10</span></Link></li>
